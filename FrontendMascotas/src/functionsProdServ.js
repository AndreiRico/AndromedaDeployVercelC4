...
function RegistrarProductoServicio(params) {
    ...
    fetch(url, {
        ...
        .then(mensaje => {
            ...
            //document.querySelector("#registroproducto").reset();  //para limpiar el formulario hago un reset para dejarlo nuevamente en blanco
        })
}